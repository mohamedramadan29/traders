                                            ...
                                            <form method="post" action="{{ url('user/invoice_create') }}">
                                                ...
                                                <div style="display: flex; align-items: center; margin-top: 10px;">
                                                    ...
                                                    <input required class="quantity" type="number"
                                                        id="quantity_{{ $plan['plan_id'] }}" name="total_price"
                                                ...
                                                <button style="display: block; width: 100%; margin-top: 20px;"
                                                    type="submit" class="btn withdraw_button">
                                                    اشتراك
                                                </button>
                                                <!-- مكان عرض الرسالة -->
                                            ...
                                            <div class="plans_details">
                                                <div class="plan1 investment_return">
                                                    ...
                                                    @php
                                                        ...
                                                        $profitLastWeek = calculateProfit(
                                                            $currentPrice,
                                                            $lastWeekPrice,
                                                        );
                                                        $profitLastMonth = calculateProfit(
                                                            $currentPrice,
                                                            $lastMonthPrice,
                                                        );
                                                    @endphp
