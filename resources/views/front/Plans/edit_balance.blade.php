        ...
        <div class="modal-content" style="background-color:#2a3040">
            ...
            <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    <button class="nav-link active" id="add_balance_tap" data-bs-toggle="tab"
                        data-bs-target="#add_balance" type="button" role="tab" aria-controls="add_balance"
                        aria-selected="true"> اضافة رصيد </button>
                    <button class="nav-link" id="withdraw_balance_tap" data-bs-toggle="tab"
                        data-bs-target="#withdraw_balance" type="button" role="tab"
                        aria-controls="withdraw_balance" aria-selected="false"> سحب رصيد </button>
                </div>
            </nav>
            <div class="tab-content" id="nav-tabContent">
                ...
                <div class="tab-pane fade" id="withdraw_balance" role="tabpanel" aria-labelledby="withdraw_balance_tap"
                    tabindex="0">
                    <form action="{{ url('user/withdraw/add') }}" method="post" class="withdraw_form">
                        @csrf
                        <div class="modal-body">
                            <input class="form-control" type="hidden" disabled readonly
                                value="{{ \Illuminate\Support\Facades\Auth::user()->name }}">
                            <div class="mb-3">
                                <label for="">المبلغ </label>
                                <input required type="number" step="0.01" name="amount" class="form-control"
